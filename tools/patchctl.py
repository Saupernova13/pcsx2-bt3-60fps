...
PRESETS = {
    ...
    #
    # Reading the binary closed part of that hole, not all of it
    # - 001E6F40 is an index into a table instead of a count of frames,
    # and it is inside FUN_001E6DC8 itself. Four more indices came out after
    # #39, and PHASE now gates 17 clocks.
